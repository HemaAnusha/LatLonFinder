...
public class AddressConverter {
	...
	public static void main(String[] args) throws IOException {
		...
		GoogleResponse res = new AddressConverter().convertToLatLong("2131 W 3rd St,Los Angeles ,CA");
		...
		System.out.println("\n");
		// GoogleResponse res1 = new
		// AddressConverter().convertFromLatLong("18.92038860,72.83013059999999");
